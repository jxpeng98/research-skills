...
- `RQSet`: Research questions
- `EvidenceTable`: Synthesized evidence
- `DesignSpec`: Study design (for empirical or qualitative papers)
...
|---|---|---|---|---|---|---|---|
| CLM-001 | X is associated with Y | result | analysis/model-1 | Smith2024 | Results, paragraph 2 | medium | hedge |
```
...
- `ManuscriptOutline`: write `RESEARCH/[topic]/manuscript/outline.md`.
- `Manuscript`: write `RESEARCH/[topic]/manuscript/manuscript.md`.
- `ClaimGraph`: write `RESEARCH/[topic]/manuscript/claims_evidence_map.md`.
- `FiguresTablesPlan`: write `RESEARCH/[topic]/manuscript/figures_tables_plan.md`.
