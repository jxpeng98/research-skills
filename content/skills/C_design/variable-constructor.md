...
- `DesignSpec`: Study design describing constructs, measures, and units
- `AnalysisPlan`: Planned estimands, model structure, and outcome definitions
- `HypothesisSet`: Hypotheses defining focal relationships
- `DatasetPlan`: Preferred data source and coverage constraints
...
- `VariableSpec`: write `RESEARCH/[topic]/design/variable_spec.md`.
