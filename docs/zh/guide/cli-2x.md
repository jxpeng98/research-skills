...
下载同一 Release 的 [SHA256SUMS](https://github.com/jxpeng98/qiongli/releases/download/v2.0.0-alpha.8/SHA256SUMS)。
...
版本应显示 `qiongli 2.0.0-alpha.8`。独立包只提供 `qiongli` 可执行文件；`ql` 别名由 npm / PyPI 安装提供。
