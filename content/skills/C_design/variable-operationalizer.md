...
- `TheoreticalFramework`: Constructs requiring operationalization
- `DesignSpec`: Study design context
...
- `OperationalizationMap`: write `RESEARCH/[topic]/design/operationalization.md`.
