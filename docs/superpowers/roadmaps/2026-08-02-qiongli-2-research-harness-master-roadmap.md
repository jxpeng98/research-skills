...
| **NEXT** | Reconcile remaining declared baseline and managed lifecycle evidence for `CLI-403/405/410`; a complete academic graph is not required. The three-platform registry distribution increment is complete (ADR 0220); Cargo stays deferred. Alpha.6 and npm stable 1.17.0 remain unchanged. Research approval/CAS is unchanged. |
