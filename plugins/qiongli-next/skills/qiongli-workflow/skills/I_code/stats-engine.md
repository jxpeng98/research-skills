...
- `AnalysisPlan`: Statistical analysis specification
- `DomainProfile`: Domain-specific diagnostics and methods
...
- `StatsReport`: write `RESEARCH/[topic]/analysis/stats_report.md`.
